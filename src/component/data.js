let data=[
    {
        ...
        rules:["Each person will be given a total of 7 minutes for the presentation.",
                "The presentation should not exceed 5 minutes, 2 minutes will be taken for asking questions.",
                "The Papers should be submitted to the below mentioned mail Id's on or before 10th November."],
    ...
    ,
    {
        ...
        rules:[ "The flags are hidden in the system.",
                "Find the maximum number of flags to win the game.",
                "The game will be played in a virtual environment.",
                "Each team may only use one computer at a time.",
                "Computers and peripherals are not to be moved or reconfigured without approval of Technical Staff.",
                "Students may not install software on lab computers. If you have a question regarding specific software that you need to use, contact the Classroom and Labs support team."],
        ...
        rules:[ "No one is allowed to compile more than once.",
                "Each person will be allowed to compile only after showing it to the event coordinator.",
...
},
    {
        ...
        rules:[ "The code should be written in any language of your choice.",
                "The code should be written in the most optimized way possible.",
                "Each person may only use one computer at a time.",                
                "Computers and peripherals are not to be moved or reconfigured without approval of Technical Staff.",
                "Students may not install software on lab computers. If you have a question regarding specific software that you need to use, contact the Classroom and Labs support team."],
