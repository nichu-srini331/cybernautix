        ...
        <div>
            ...
            <div className="container-fluid pad">
                <div className="row r1 text-center">
                    <h1 className="gradient-text" style={{ fontSize: "50px" }}>
                        {x.event}
                    </h1>
                </div>
                <br></br>
                <div className="row text-center">
                    <div class="col">
                        <h6 style={{ color: "whitesmoke", fontSize: "22px" }}>Timing</h6>
                        <p className="gradient-text">{x.time}</p>
                    </div>
                    <div class="col">
                        <h6 style={{ color: "white", fontSize: "22px" }}>Venue</h6>
                            ...
                            <div class="card-body" >
                                <h6 class="card-text" style={{ color: "whitesmoke" }}>
                                    <ul>
                                        ...
                                        <span> to join Whatsapp group</span>
                                    </ul>
                                </h6>
                            </div>
                        </div>
